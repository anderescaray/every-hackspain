...
export function CompanyInsights({ company }: { company: CompanyDetail }) {
  ...
  return <main className={styles.page} id="company-insights">
      ...
      <div className={styles.healthOverview}>
        ...
        <section className={styles.composition} aria-label="Composición del Health Score">
          ...
          <details className={styles.methodology}>
            ...
            <p>Método: {company.health_score_model.version}{company.health_score_model.provisional ? " · pesos provisionales" : ""}. El Health Score y las dimensiones se reciben ya calculados.</p>
          </details>
        </section>
      </div>
    </header>
    ...
    <section className={styles.panel} aria-label="Alertas priorizadas">
      <SectionHeading number="06" title="Alertas" description="Prioridades de revisión."><span className={styles.periodBadge}>{alerts.length} alertas</span></SectionHeading>
