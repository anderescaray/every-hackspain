...
export function WhatIfSection({ currentHealthScore, simulation }: { currentHealthScore: number | null; simulation: Simulation }) {
  ...
  return <section id="scenarios" className={styles.panel} aria-label="Stress Testing" data-company-section="scenarios">
    <SectionHeading number="05" title="Stress Testing" description="Efecto estimado en el Health Score si cambian plazos o apoyo."><span className={styles.scenarioBadge}>Escenario, no predicción.</span></SectionHeading>
