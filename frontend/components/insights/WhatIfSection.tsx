...
export function WhatIfSection({ currentHealthScore, simulation }: { currentHealthScore: number; simulation: Simulation }) {
  ...
  return <section className={styles.panel} aria-label="Simulador de escenarios">
    <SectionHeading number="07" title="Simulador de escenarios" description="¿Qué cambiaría bajo otras condiciones? Consulta los escenarios preparados por el equipo de datos."><span className={styles.scenarioBadge}>Escenario, no predicción.</span></SectionHeading>
