...
const manifestSchema = z.object({ schema_version: z.literal("1.0"), ...pulseEnvelopeShape, source_manifest_sha256: sha, exporter_version: z.enum(["pulse-frontend-v1", "pulse-frontend-v1.1", "pulse-frontend-v1.2"]), outputs_sha256: z.record(sha), counts: z.record(z.unknown()) }).passthrough();
