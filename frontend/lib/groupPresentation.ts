...
export const signalLabels: Record<GroupRecommendation["signals"][number]["source"], string> = { health: "Diagnóstico de caja", momentum: "Momentum", resilience: "Resiliencia", cash_truth: "Origen de la caja", network: "Red financiera", liquidity: "Liquidez", obligations: "Deuda y obligaciones", outlook: "Perspectiva futura", concentration: "Concentración", confidence: "Calidad de los datos" };
