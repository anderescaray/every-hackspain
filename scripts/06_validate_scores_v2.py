...
from xray.score_v2.pipeline import validate_saved_scores


def main():
    parser = argparse.ArgumentParser(description="Verifica integridad, explicaciones y causalidad del score V2.")
