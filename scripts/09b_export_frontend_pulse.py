...
from xray.product.pulse_frontend_export import FRONTEND_GENERATED, run  # noqa: E402
...
def main():
    ...
    parser.add_argument("--currency", choices=("EUR",), default="EUR", help="Vista en EUR: desde D32 el libro de caja convierte todas las monedas a EUR con tipo fijo")
