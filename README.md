...
1. Producto y demo sobre V2: cartera con `trajectory`/`episode`, ficha con la tabla de contribuciones y el relato «nivel 6m · trimestre reciente frente a anterior · mes actual» (decisiones §11 y §13).
